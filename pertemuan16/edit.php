    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <ul>
            <li>
                ...
                <input type="text" name="nama" id="nama" autocomplete="off" required value="<?= $karyawan["nama"]; ?>"></input>
            </li><br>
            <li>
                <label for="nik" name="nik">Nik</label>
                <input type="text" name="nik" id="nik" autocomplete="off" required value="<?= $karyawan["nik"]; ?>"></input>
            </li><br>
            <li>
                <label for="jabatan" name="jabatan">Jabatan</label>
                <input type="text" name="jabatan" id="jabatan" autocomplete="off" required value="<?= $karyawan["jabatan"]; ?>"></input>
            </li><br>
            <li>
                <label for="email" name="email">Email</label>
                <input type="email" name="email" id="email" autocomplete="off" required value="<?= $karyawan["email"]; ?>"></input>
            </li><br>
            <li>
